...
// top-level init chain) into any caller that bundles `apex-ink` from
...
//
//     import TextInput from 'apex-ink/text-input'
//
...
// ---- apex 便捷导出（标准 Ink 兼容层：the vendored ink renderer 未在 entry-exports 暴露的常用 API） / apex convenience exports (standard Ink compatibility layer: common APIs the vendored ink renderer does not expose in entry-exports) ----
export { TerminalSizeContext, type TerminalSize } from './ink/components/TerminalSizeContext.js'
